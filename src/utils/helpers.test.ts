...
describe('utils.validateCVE', () => {
  ...
  it('rejects invalid CVE identifiers', () => {
    ...
    expect(utils.validateCVE('CVE-2024-ABCD')).toBe(false)
    expect(utils.validateCVE('CVE-2024-1234;rm -rf /')).toBe(false)
    expect(utils.validateCVE('CVE-2024-123456789012345')).toBe(false)
  })
})

describe('utils.getVulnerabilityUrl', () => {
  it('returns correct URL for CVE', () => {
